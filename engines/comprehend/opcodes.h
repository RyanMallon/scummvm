...
enum {
	...
	OPCODE_CURRENT_OBJECT_IS_NOT_NOWHERE,
...
public:
	OpcodeMapV1() : OpcodeMap() {
		...
		_map[0x14] = OPCODE_CURRENT_OBJECT_NOT_VALID;
		...
		_map[0x50] = OPCODE_CURRENT_OBJECT_IS_NOT_NOWHERE;
...
class OpcodeMapV2 : public OpcodeMap {
public:
	OpcodeMapV2() : OpcodeMap() {
		_map[0x01] = OPCODE_HAVE_OBJECT;
		_map[0x04] = OPCODE_OR;
		_map[0x05] = OPCODE_IN_ROOM;
		_map[0x06] = OPCODE_VAR_EQ;
		_map[0x08] = OPCODE_CURRENT_IS_OBJECT;
		_map[0x09] = OPCODE_OBJECT_PRESENT;
		_map[0x0c] = OPCODE_ELSE;
		_map[0x11] = OPCODE_OBJECT_IS_NOWHERE;
		_map[0x14] = OPCODE_CURRENT_OBJECT_NOT_VALID;
		_map[0x19] = OPCODE_TEST_FLAG;
		_map[0x1d] = OPCODE_TEST_ROOM_FLAG;
		_map[0x20] = OPCODE_HAVE_CURRENT_OBJECT;
		_map[0x21] = OPCODE_OBJECT_PRESENT;
		_map[0x22] = OPCODE_OBJECT_IN_ROOM;
		_map[0x30] = OPCODE_CURRENT_OBJECT_PRESENT;
		_map[0x31] = OPCODE_TEST_ROOM_FLAG;
		_map[0x38] = OPCODE_INVENTORY_FULL;
		_map[0x41] = OPCODE_NOT_HAVE_OBJECT;
		_map[0x45] = OPCODE_NOT_IN_ROOM;
		_map[0x48] = OPCODE_CURRENT_OBJECT_IS_NOWHERE;
		_map[0x43] = OPCODE_OBJECT_NOT_IN_ROOM;
		_map[0x59] = OPCODE_TEST_NOT_FLAG;
		_map[0x5d] = OPCODE_TEST_NOT_ROOM_FLAG;
		_map[0x60] = OPCODE_NOT_HAVE_CURRENT_OBJECT;
		_map[0x61] = OPCODE_OBJECT_NOT_PRESENT;
		_map[0x70] = OPCODE_CURRENT_OBJECT_NOT_PRESENT;
		_map[0x74] = OPCODE_CURRENT_NOT_OBJECT;
		_map[0x80] = OPCODE_INVENTORY;
		_map[0x81] = OPCODE_TAKE_OBJECT;
		_map[0x82] = OPCODE_MOVE_OBJECT_TO_ROOM;
		_map[0x84] = OPCODE_SAVE_ACTION;
		...
		_map[0x86] = OPCODE_VAR_ADD;
		_map[0x87] = OPCODE_SET_ROOM_DESCRIPTION;
		_map[0x89] = OPCODE_SPECIAL;
		_map[0x8a] = OPCODE_VAR_SUB;
		_map[0x8b] = OPCODE_SET_OBJECT_DESCRIPTION;
		_map[0x8c] = OPCODE_MOVE;
		_map[0x8e] = OPCODE_PRINT;
		_map[0x8f] = OPCODE_SET_OBJECT_LONG_DESCRIPTION;
		_map[0x90] = OPCODE_WAIT_KEY;
		_map[0x92] = OPCODE_CALL_FUNC;
		_map[0x95] = OPCODE_REMOVE_OBJECT;
		_map[0x98] = OPCODE_TURN_TICK;
		_map[0x99] = OPCODE_SET_FLAG;
		...
		_map[0x9e] = OPCODE_INVENTORY_ROOM;
		_map[0xa0] = OPCODE_TAKE_CURRENT_OBJECT;
		_map[0xa2] = OPCODE_SET_OBJECT_GRAPHIC;
		_map[0xb1] = OPCODE_DO_VERB;
		_map[0xb5] = OPCODE_DESCRIBE_CURRENT_OBJECT;
		_map[0xc1] = OPCODE_VAR_DEC;
		_map[0xc2] = OPCODE_SET_ROOM_GRAPHIC;
		_map[0xc5] = OPCODE_SET_CURRENT_NOUN_STRING_REPLACEMENT;
		_map[0xc6] = OPCODE_SET_OBJECT_GRAPHIC;
		_map[0xc9] = OPCODE_MOVE_CURRENT_OBJECT_TO_ROOM;
		_map[0xcd] = OPCODE_SET_STRING_REPLACEMENT;
		_map[0xd1] = OPCODE_MOVE_DIRECTION;
		_map[0xd5] = OPCODE_DRAW_ROOM;
		_map[0xd9] = OPCODE_DRAW_OBJECT;
		_map[0xdd] = OPCODE_VAR_INC;
		_map[0xe1] = OPCODE_MOVE_OBJECT_TO_CURRENT_ROOM;
		_map[0xed] = OPCODE_REMOVE_OBJECT;
		_map[0xf0] = OPCODE_DROP_CURRENT_OBJECT;
		_map[0xfc] = OPCODE_REMOVE_CURRENT_OBJECT;
	};
};
